#!/usr/bin/env python
"""GPT-5.3 reason-based differential prediction on all MIDAS lesions."""
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "collect_ai_response", "gpt53"))
...
OUT_PATH = os.path.join(RESULTS_DIR, "gpt53_predictions_reason.csv")
