#!/usr/bin/env python
"""DermatoLlama prediction on all MIDAS lesions with checkpointing."""
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "dermato_llama"))
...
OUT_PATH = os.path.join(RESULTS_DIR, "dermato_llama_predictions_all.csv")
