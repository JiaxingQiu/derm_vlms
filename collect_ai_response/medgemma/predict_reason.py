#!/usr/bin/env python
"""MedGemma reason-based differential prediction on all MIDAS lesions."""
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "collect_ai_response", "medgemma"))
...
OUT_PATH = os.path.join(RESULTS_DIR, "medgemma_predictions_reason.csv")
