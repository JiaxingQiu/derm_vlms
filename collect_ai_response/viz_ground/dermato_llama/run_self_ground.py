#!/usr/bin/env python
"""Run DermatoLlama self-grounding on its predictions CSV.

Asks DermatoLlama to draw bounding boxes for its OWN reasoning sentences.
Output has the same column structure as the Qwen3 external grounding CSV,
written to a SEPARATE file:

    dermato_llama_predictions_reason_viz_self.csv
...
def main():
    parser = argparse.ArgumentParser(description="DermatoLlama self-grounding")
